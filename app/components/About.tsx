    ...
    <div className="flex items-center justify-center py-8 md:py-0 md:h-screen">
      <div className="flex flex-col w-4/5 gap-3 md:gap-6">
        ...
        <div className="text-xl md:text-3xl font-medium text-stone-300 text-justify">
          A passionate{" "}
          <span className="text-primary">Full stack developer</span> currently
          ...
          <span className="text-primary">Backend </span>development, where I
          find myself thriving.
          <br />
          <br />I have a strong command of the {""}
          <span className="text-primary">MERN</span> stack, allowing me to
          ...
          {""}
          <span className="text-primary">contributed</span> to the community.
